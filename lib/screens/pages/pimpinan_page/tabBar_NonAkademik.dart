...
import 'package:simobel/screens/pages/pimpinan_page/kelas_nonAkademik.dart';

class ItemNonAkademikPimpinan extends StatelessWidget {
  const ItemNonAkademikPimpinan({super.key});
        ...
        child: Column(
          children: [
            ...
            Obx(() => SizedBox(
                ...
                child: FutureBuilder(
                    future: PimpinanController().getMonitoringNonAkademik(
                    ...
                    builder: (context, AsyncSnapshot snapshot) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        var kegiatan = data['jadwal-kegiatan'];
                        // print(data
                        return ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              var nilaiPersen = double.parse(
                                  kegiatan[index]['terlaksana'].toString());

                              var persen = nilaiPersen * 100;
                              // if(index==kegiatan.length)
                              // var stringpersen = persen.toString;
                              // print('=================');
                              ...
                              return Container(
                                ...
                                child: Center(
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                        '${kegiatan[index]['waktu_mulai'].toString().substring(0, 5)}-${kegiatan[index]['waktu_berakhir'].toString().substring(0, 5)}',
                                    ...
                                    onTap: () {
                                      var namaKegiatan =
                                          kegiatan[index]['kegiatan'];
                                      var kegiatanId =
                                          kegiatan[index]['kegiatan_id'];
                                      var waktuMulai =
                                          kegiatan[index]['waktu_mulai'];
                                      var waktuBerakhir =
                                          kegiatan[index]['waktu_berakhir'];
                                      var angkatanId =
                                          kegiatan[index]['angkatan'];

                                      Navigator.of(context).push(
                                          MaterialPageRoute(builder: (context) {
                                        print(namaKegiatan);
                                        print(kegiatanId);
                                        print(hariAktif.value);
                                        print(tanggalHariIni);
                                        return KelasNonAkademik(
                                            angkatanId,
                                            tanggalHariIni,
                                            hariAktif.value,
                                            namaKegiatan,

...
import 'package:simobel/screens/pages/wAsrama_page/presKegNara.dart';

class KegNarasumber extends StatelessWidget {
  KegNarasumber(this.jadwalId, this.jamMulai, this.jamSelesai, this.kegiatanId,
      {super.key});
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              ...
                              Navigator.of(context)
                                ...
                                return PresensiKegNara(namaKelas, jadwalId,

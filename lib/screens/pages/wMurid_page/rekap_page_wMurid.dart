...
class RekapKehadiranSiswa extends StatefulWidget {
  const RekapKehadiranSiswa({super.key});
  ...
  @override
  State<RekapKehadiranSiswa> createState() => _RekapKehadiranSiswaState();
}

class _RekapKehadiranSiswaState extends State<RekapKehadiranSiswa> {
  ...
  void initState() {
    ...
    FlutterDownloader.registerCallback(RekapKehadiranSiswa.downloadCallback);
  }
